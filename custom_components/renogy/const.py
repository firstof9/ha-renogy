...
SENSOR_TYPES: Final[dict[str, SensorEntityDescription]] = {
    ...
    "batterySoc": SensorEntityDescription(
        key="batterySoc",
    ...
    "controllerTemperature": SensorEntityDescription(
    ...
    # DC-DC Charger
    "dc-dcMpptTemperature": SensorEntityDescription(
        key="dc-dcMpptTemperature",
        name="DC-DC Temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.TEMPERATURE,
    ),
    "starterBatteryAmps": SensorEntityDescription(
        key="starterBatteryAmps",
        name="Starter Battery Ampers",
        icon="mdi:sine-wave",
        native_unit_of_measurement=UnitOfElectricCurrent.MILLIAMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.CURRENT,
    ...
    "solarInputAmps": SensorEntityDescription(
        key="solarInputAmps",
        name="Solar Input Ampers",
        icon="mdi:sine-wave",
        native_unit_of_measurement=UnitOfElectricCurrent.MILLIAMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.CURRENT,
    ...
    "auxiliaryBatteryVolts": SensorEntityDescription(
        key="auxiliaryBatteryVolts",
    ...
    "solarInputVolts": SensorEntityDescription(
        key="solarInputVolts",
    ...
    "starterBatteryVolts": SensorEntityDescription(
        key="starterBatteryVolts",
